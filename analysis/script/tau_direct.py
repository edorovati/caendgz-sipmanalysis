...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(description="Compute tau from a .npz file of waveform(s).")
    ...
    # === Compute tau ===
    waveform_analysis.compute_tau(waveforms, sampling=args.sampling, output_filename=output_base + ".txt")
